...
const Home = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const dummySearchResults = [
      { trainNumber: '12345', departure: '08:00 AM', arrival: '12:00 PM' },
      { trainNumber: '67890', departure: '02:00 PM', arrival: '06:00 PM' },
    ];
  ...
  <form onSubmit={handleSubmit}>
    ...
    <button
      type="submit"
      className="inline-block rounded bg-purple-600 px-6 pb-2 pt-2.5 text-xs font-medium uppercase leading-normal shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700"
      data-te-ripple-init=""
